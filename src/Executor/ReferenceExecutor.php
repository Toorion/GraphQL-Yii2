...
use YiiGraphQL\Type\Definition\AbstractType;
...
use YiiGraphQL\Type\Definition\LeafType;
...
class ReferenceExecutor implements ExecutorImplementation
{
    ...
    private function executeOperation(OperationDefinitionNode $operation, $rootValue)
    {
        ...
        try {
            $result = $operation->operation === 'mutation' ?
                $this->executeFieldsSerially($model, $rootValue, $path, $fields) :
                $this->executeFields($model, $rootValue, $path, $fields);
     ...
     * @throws Error
     */
    private function getOperationRootModel(QueryModel $model, OperationDefinitionNode $operation)
    {
...
//                return $queryType;
     ...
     */
    private function resolveOrError($_args, $fieldNode, $resolveFn, $source, $context, $info)
    {
        try {
